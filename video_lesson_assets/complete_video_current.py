...
BACKGROUND_IMG = "static_slides/slide_intro.png"  # Fallback to a slide image
INTRO_VIDEO_PATH = "static_slides/slidevid_intro.mp4"
...
def main():
    ...
    # Use first Pet line as intro, then continue with remaining lines
    video_segments = []
