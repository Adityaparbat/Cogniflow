...
import { Sparkles, Star, Smile, PartyPopper, ArrowLeft, ArrowRight, RotateCcw, Shuffle, BookOpen, CheckCircle, XCircle, Eye, FileText } from 'lucide-react';
    ...
    const loadPDFCards = async () => {
      ...
      try {
        ...
        if (module.generatedFlashcards && module.generatedFlashcards.length > 0) {
          let flashcardSet = module.generatedFlashcards;
          ...
          setError('No flashcards found in the PDF-generated content');
        }
      } catch (error) {
        console.error('Error loading PDF flashcards:', error);
    ...
    return (
      <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
        <div className="bg-white rounded-2xl p-8 text-center">
          ...
          <p className="text-gray-600">Loading PDF flashcards...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
        <div className="bg-white rounded-2xl p-8 text-center max-w-md">
          ...
          <p className="text-gray-600 mb-6">
            No flashcards were generated from the PDF content for {subject} - {chapter}.
          </p>
          <button
            onClick={onClose}
            className="bg-blue-500 text-white px-6 py-2 rounded-lg hover:bg-blue-600 transition-colors"
        ...
        <div className="bg-gradient-to-r from-green-500 to-blue-500 p-6 text-white">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h2 className="text-2xl font-bold">PDF Flashcards</h2>
